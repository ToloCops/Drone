...
CREATE TABLE IF NOT EXISTS TimeVar (
        ...
        varname String4VarName NOT NULL UNIQUE,     -- variable name
...
CREATE TABLE IF NOT EXISTS LogTable (
        timevalue TimePoint NOT NULL,		-- time of reading YYYY-MM-DD hh-mm-ss
	...
	loginfo String4Info,                    -- extra info
        PRIMARY KEY (timevalue, nanosec, pid, vid),
